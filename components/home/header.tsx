      ...
      <div className="max-w-[1280px] flex justify-between m-auto items-center py-4 px-4">
        <div
          className={`flex items-center gap-2 ${
            isMobileSearchActive ? "sm:flex hidden" : ""
          }`}
        >
        ...
        <div
          className={`flex gap-2 items-center ${
            isMobileSearchActive ? "w-full sm:w-auto" : ""
          }`}
        >
          <div
            className={isMobileSearchActive ? "w-full sm:w-auto" : "sm:hidden"}
          >
            <SearchSection onMobileSearchToggle={setIsMobileSearchActive} />
          </div>
          <div className={isMobileSearchActive ? "hidden sm:block" : ""}>
            <ThemeToggler />
          </div>
        </div>
      </div>
